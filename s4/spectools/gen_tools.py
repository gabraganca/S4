...
def rvcorr(rad_vel):
    ...
    When  a wavelength array is multiplied by RVCORR, the array is dislocated
...
def get_equiv_width(spectrum_flux):
    """
    Obtain the equivalent width.

    Parameters
    ----------

    spectrum flux: ndarray;
        A list with values of the normalized flux
